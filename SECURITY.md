...
Instead, use the private security reporting channel for this repository, or contact the maintainer through the repository profile, with:
...
- **Dashboard** (`dashboard-web/`) — Fastify server, WebSocket terminal, frontend XSS
...
- CareerBot is a local tool — there is no hosted service to attack
