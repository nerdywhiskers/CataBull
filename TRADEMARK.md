...
- **This policy covers the name and brand.** It is permissive for
  community use and reserved for commercial product naming and
  endorsement.
...
- **The code is MIT licensed.** As the license requires, the original
  copyright notice stays in [LICENSE](LICENSE).
...
open-source projects: the code is free, the brand is stewarded.
...
Email nerdywhiskers@gmail.com with subject "Trademark request: [your use
case]" and include:
...
when granted, is non-exclusive, revocable, and limited to the use
described.

## Why this policy exists

A clear brand lets the code stay free, the documentation stay
trustworthy, and users stay confident that no one is impersonating the
project. This policy is meant to be permissive, not punitive. If you have
read this far and are unsure where your case lands, write us. We would
rather have the conversation than a surprise.
...
and the [Mozilla Trademark Policy](https://www.mozilla.org/en-US/foundation/trademarks/policy/).

## Updates

This policy may change as the project evolves. Material changes will be
