const HARD_EXPIRED_PATTERNS = [
  ...
  /no longer (accepting|taking|receiving)\s+(applications?|applicants?|candidates?|submissions?)/i,
  /no longer open/i,
  /no longer active/i,
  /(role|job|position|posting|opportunity) (has been|is)?\s*filled/i,
  /(role|job|position|posting|opportunity) (has been|is)?\s*(cancelled|canceled|inactive|unavailable|removed|taken down)/i,
  ...
  /this (job|role|position|posting|opportunity) (has )?expired/i,
  /this (job|role|position|posting|opportunity) is no longer (available|open|active)/i,
  /this (job|role|position|posting|opportunity) has been (filled|closed|removed|taken down)/i,
  /application window (has )?closed/i,
  /applications? (are )?(closed|no longer being accepted)/i,
  ...
  /job requisition .* is no longer available/i,
  /sorry, this job is no longer available/i,
  /sorry, this position is no longer available/i,
