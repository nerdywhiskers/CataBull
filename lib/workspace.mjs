...
export class LocalWorkspace {
  ...
  /** Delete a file. Returns true if it was removed, false if it didn't exist. */
  delete(relPath) {
    const abs = this.resolve(relPath);
 ...
 * string, or undefined (uses CAREERBOT_WORKSPACE_ROOT env or process.cwd()).
 *
...
export function asWorkspace(rootOrWorkspace) {
  ...
  if (rootOrWorkspace == null) {
    const envRoot = process.env.CAREERBOT_WORKSPACE_ROOT;
 ...
 *
 * Resolution order:
 *  1. CAREERBOT_WORKSPACE_ROOT env var (explicit override)
