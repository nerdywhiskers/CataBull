...
/**
 * test-all.mjs — Comprehensive test suite for CareerBot
 *
...
const systemFiles = [
  ...
  '.claude/skills/careerbot/SKILL.md',
];
...
const expectedModes = [
  '_shared.md', '_profile.template.md', 'apply.md', 'auto-pipeline.md',
  'batch.md', 'deep.md', 'followup.md', 'humanizer.md', 'interview-prep.md',
  'outreach.md', 'patterns.md', 'pdf.md', 'pipeline.md', 'project.md',
  'scan.md', 'tracker.md', 'training.md',
];
...
const requiredSections = [
  ...
  'Canonical States', 'First Run', 'Onboarding',
];
