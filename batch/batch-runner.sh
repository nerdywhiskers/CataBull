...
# CataBull batch runner — standalone orchestrator for claude -p workers
...
usage() {
  cat <<'USAGE'
CataBull batch runner — process job offers in batch via claude -p workers
